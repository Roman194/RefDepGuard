...
_!Важно: в отличие от расширения, консольное приложение не умеет генерировать шаблоны файлов конфигурации, поэтому любые синтаксические ошибки приведут к неудачному парсингу правил и потребуют поиска проблем и их редактирования вручную!_
</br>
</br>
...
_!Важно: в случае, если в результате проверки будут обнаружены ошибки или проверка по каким-то причинам не сможет произойти (fail на 1-3 этапе), программа заканчивает выполнение с кодом "-1", что соответствует завершению с ошибкой. В противном случае - с кодом "0" (успешное выполнение)!_
