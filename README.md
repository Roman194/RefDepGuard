# Общая информация
Данное расширение для Visual Studio 2022 позволяет отслеживать изменения зависимостей между проектами и сопоставлять эти зависимости с правилами, заданными в специальном конфиг-файле. В случае несоответствия изменений связей заданным настройкам (обнаружены ошибки / errors), расширение выдаёт предупреждение о некорректных связях и не даёт сборке завершиться.
...
Среди расширений выберите расширение "RefDepGuard".
...
**framework_max_version illegal template usage warning** - Возникает, когда в шаблоне различных ограничений на уровнях Solution/Global задан существующий TFM, не релевантный ни для одного проекта текущего решения.</br>
</br>
...
**Project name semantic warning** - Выводится, если в решении есть проекты, имеющие в названии отклонение от выявленных правил. Требует проставления соответствующего разрешения на уровнях Solution и Global.</br>
</br>
...
**Transit references duplicate warning** - Возникает, если в решении обнаружены транзитивные связи между проектами, дублирующие уже существующие прямые связи. Также требует проставленного разрешения на всех 3-х уровнях.</br>
...
_! Исключение: в параметрах "report_on_transit_references" и "project_names_semantic_check" используется обратная логика приоритезации!_
...
<img width="655" height="664" alt="image" src="https://github.com/user-attachments/assets/183f465f-df7f-4f31-b7a2-d415f593c621" />
