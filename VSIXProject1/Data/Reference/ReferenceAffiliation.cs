...
namespace VSIXProject1
{
    ...
    {
        public ErrorLevel ReferenceTypeValue;
        public List<string> RequiredReferences;
        public List<string> UnacceptableReferences;

        public ReferenceAffiliation(ErrorLevel referenceType, List<string> requiredReferences, List<string> unacceptableReferences)
        {
